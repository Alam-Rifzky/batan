        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Table Scram
                            </li>
                        </ol>
                    </div>
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <h2>Tabel </h2>
                           <a href="formscram.php">Tambah Data</a>
                            <div class="btn-group">
...
<?php }?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><i class="fa fa-trash-o" aria-hidden="true"><a href="delete2.php?id=<?php echo $row[0];?>">Delete</i></td>
                                    </tr>
                                </tbody>
                                <?php 
                            ...
                            <?php 
                                 $Total= "SELECT * FROM datascram";
                                 $Total1= mysql_query($Total) or die(mysql_error());
                            ...
                            <p>Total Energi dari semua teras yang digunakan adalah : <?php echo $x;?> </p>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
