...
echo $no;
$query = "SELECT * FROM dataoperasi WHERE id='".$no."'";
                ...
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="form-group">
                               ...
                               <input class="form-control" type="text" name="koko" value="<?php echo $row[2];?>" />
                            </div>

                            <div class="form-group">
                                <label>Nama Komponen</label>
                            
                               <input class="form-control" type="text" name="nkom" value="<?php echo $row[3];?>" />
                            ...
                            <div class="form-group">
                               ...
                               <input class="form-control" type="text" id="top" name="top" value="<?php echo $row[5];?>" />
                            ...
                            <div class="form-group">
                               ...
                               <input class="form-control" type="text" id="tmin" name="tmin" value="<?php echo $row[6];?>" />
                            ...
                            <div class="form-group">
                               ...
                               <input class="form-control" type="text" id="tmax" name="tmax" value="<?php echo $row[7];?>" />
                            ...
                            <div class="form-group">
                               ...
                               <input class="form-control" type="text" id="ket" name="ket" value="<?php echo $row[8];?>" />
