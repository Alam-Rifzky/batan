                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input class="form-control" name="nkom" placeholder="Enter text" value="<?php echo $row[2];?>">
                            </div>
                            ...
                            <div class="form-group">
                               ...
                               <input class="form-control" type="text" name="datefilter" value="<?php echo $row[3];?>" />
 

                            </div>
                            <div class="form-group">
                                <label>Jam</label>
                                <input class="form-control" name="jam" placeholder="Enter text" value="<?php echo $row[4];?>">
                            </div>


                            <div class="form-group">
                                <label>&isin; Jam</label>
                                <input class="form-control" name="jml_jam" placeholder="Enter text" value="<?php echo $row[5];?>">
                         
                            </div>

                            <div class="form-group">
                                <label>&isin; MWD</label>
                                <input class="form-control" id="top" name="top" placeholder="Enter text" value="<?php echo $row[6];?>">
                            </div>
                             <div class="form-group">
                                <label>Penyebab</label>
                                <input class="form-control" id="ket" name="ket" placeholder="Enter text" value="<?php echo $row[7];?>">
                            </div>
